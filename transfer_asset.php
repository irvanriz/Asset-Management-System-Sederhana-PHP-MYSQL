					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Transfer Data Asset</li>
							</ol>
						</nav>
					</div>
				</div>
							...
							<div class="card-body">
								<div class="border p-4 rounded">
									<div class="card-title d-flex align-items-center">
										<h5 class="mb-0 text-info">Transfer Data Asset</h5>
									</div>
									<hr/>
									<?php 
										include "koneksi.php";
									...
									<form action="aksi\asset\transfer.php" method="POST">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="text" name="nama_user" class="form-control" id="inputConfirmPassword2" value="<?php echo $data['nama_user'] ?>">
											</div>
										</div>
										<div class="row mb-3">
												...
												<select class="single-select" name="id_divisi">
													<option value="<?php echo $data['divisi'] ?>"> <?php echo $data['divisi'] ?> </option>
														<?php
															...
															while ($div = mysqli_fetch_array($hasil)) {
														?>
														<option value="<?php echo $div['id'];?>"><?php echo $div['divisi'];?></option>
														  <?php 
															}
														  ?>
												</select>
